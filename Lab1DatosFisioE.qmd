...
```{r} 
#| echo: true
nombres=c("marca_temp","email","nombre","documento","f_nac", "edad","sexo","tel", "consentimiento", "par_q","apto","restriccion","fcr","presion_sis","presión_dia","estatura","masa_corporal","cintura","imc","masa_grasa","masa_muscular","masa_osea","grasa_vis", "fuerza_md","fuerza_mi")
```
